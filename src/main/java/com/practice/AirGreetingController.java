...
@RestController
public class AirGreetingController {
    private static final Logger LOGGER = LoggerFactory.getLogger(AirGreetingController.class);
    private final ChatClient chatClient;
    public AirGreetingController(ChatClient chatClient) {
